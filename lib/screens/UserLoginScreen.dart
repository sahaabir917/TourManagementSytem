  ...
  checkIsLoginMood() async {
    ...
    if (preferences.getBool("isLogin") == true) {
      ...
      TourUser usersModel1 =
          TourUser.fromJson(json.decode(preferences.getString("userData")));
      ...
      LoginNotifier loginNotifier =
          Provider.of<LoginNotifier>(context, listen: false);
      FailedModel failedModel = FailedModel.fromJson(
          json.decode(preferences.getString("failedloginmsg")));
      if(failedModel!=null){
